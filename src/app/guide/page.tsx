      ...
      infobox={
        <Infobox
          ...
          rows={[
            ...
            { label: "Dungeons", value: <Link href="/dungeons">Dungeon list</Link> },
          ]}
        />
      }
    >
      <p>
        Drop tables for fruit boxes and Verdandi chests. Dungeon routes live on{" "}
      ...
      <p>
        Infinite Mountain’s Champion{" "}
        <Link href="/digimon/donedevimon">Devimon</Link> is the Giga Box farm.
        Same scan ladder as Mega Box, better fruit-box rate (19% vs 9%).
      </p>
